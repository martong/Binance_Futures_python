...
class RestApiRequestImpl(object):
    ...
    def start_user_data_stream(self):
        ...
        request = self.__create_request_by_post_with_signature("/api/v3/userDataStream", builder)
    ...
    def keep_user_data_stream(self):
        ...
        request = self.__create_request_by_put_with_signature("/api/v3/userDataStream", builder)
    ...
    def close_user_data_stream(self):
        ...
        request = self.__create_request_by_delete_with_signature("/api/v3/userDataStream", builder)
